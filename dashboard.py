...
class NAPINPUT(customtkinter.CTkFrame):
    def __init__(self, *args, master, header_name="Nap input", **kwargs):
        super().__init__(master, *args, **kwargs)
        self.header_name = header_name
        self.label = customtkinter.CTkLabel(self, width=160, height=25, fg_color=("light blue", "blue"), corner_radius=8,anchor="center", text="Nap input", font=('Arial', 18))
        self.label.grid(row=0, column=0, padx=10, pady=10)
        ...
        self.Errorlabel = customtkinter.CTkLabel(self, width=120,text_color='#FFFFFF' ,height=25, corner_radius=8, anchor="center", text= "nap invoeren!", font=('Arial', 18), )
